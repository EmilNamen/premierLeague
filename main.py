...
homeNameNewCSV = ['Tottenham Hotspur','Arsenal FC','Chelsea FC','Manchester United','Liverpool FC','Manchester City','Everton FC','Southhampton FC']
...
visitorNameNewCSV = ['Arsenal FC','Tottenham Hotspur','Manchester United','Chelsea FC','Manchester City','Liverpool FC','Southhampton FC','Everton FC']
